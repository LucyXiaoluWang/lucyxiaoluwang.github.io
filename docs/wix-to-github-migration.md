# Wix → GitHub Pages Migration Guide

Reference notes from the June 2026 site migration.
...
## 2. Download files from Wix (do this while the Wix site is still up)
...
## 4. DNS: Point lucyxiaoluwang.com at GitHub Pages
